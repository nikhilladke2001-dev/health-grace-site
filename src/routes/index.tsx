...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Providing compassionate, world-class healthcare with expert physicians and advanced technology since 1985." },
    ],
  }),
  component: Index,
});
    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-hero-gradient-start to-hero-gradient-end">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
          <div className="max-w-2xl">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-accent-warm">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/80 sm:text-xl">
              Compassionate, world-class medical care delivered by over 200 specialists using
              cutting-edge technology — because your wellbeing deserves nothing less.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            From emergency care to specialized treatments, our team of experts is here to
            provide comprehensive healthcare solutions tailored to your needs.
          </p>
        </div>
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-7xl px-4 py-24 text-center sm:px-6 lg:px-8">
          <h2 className="font-heading text-3xl font-bold text-surface-foreground sm:text-4xl">
            Ready to Take the Next Step?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Schedule an appointment with one of our specialists today and experience
            healthcare that puts you first.
          </p>
          <div className="mt-8">
            <Link to="/contact">
              <Button size="xl">Book an Appointment</Button>
            </Link>
          </div>
        </div>
      </section>
